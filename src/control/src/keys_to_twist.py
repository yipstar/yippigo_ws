...
g_vel_scales = [0.1, 0.1] # default to very swol
...
def send_twist():
    ...
    g_last_twist = ramped_twist(g_last_twist, g_target_twist, g_last_twist_send_time, \
                                t_now, g_vel_ramps)
...
if __name__ == '__main__':
    ...
    g_target_twist = Twist() # inits to zero
    g_last_twist = Twist()
